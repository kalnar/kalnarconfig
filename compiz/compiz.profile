...
[rotate]
s0_rotate_left_window_key = <Control><Alt><Super>Left
s0_rotate_right_window_key = <Control><Alt><Super>Right
...
[core]
s0_active_plugins = core;composite;opengl;imgpng;annotate;obs;workarounds;place;session;expo;mousepoll;compiztoolbox;grid;vpswitch;move;commands;scale;extrawm;snap;regex;wall;resize;ezoom;winrules;staticswitcher;unityshell;
...
s0_show_launcher = <Shift><Control><Alt><Super>
